      ...
      <div className="mt-10 uc-card overflow-hidden">
        {result ? (
          <div className="p-6 sm:p-7">
            ...
            <div className="mt-6 flex flex-col items-start gap-5 sm:flex-row sm:items-center">
              <img
                ...
                className="h-32 w-32 rounded-md border border-line bg-white p-1"
              />
            ...
            <button
              ...
              className="mt-7 uc-btn-ghost w-full"
            >
              Shorten another
            </button>
          </div>
          ...
          <form onSubmit={handleSubmit} className="p-6 sm:p-7">
            ...
            <div className="flex items-stretch overflow-hidden rounded-md border border-line focus-within:border-accent focus-within:ring-2 focus-within:ring-accent/20">
